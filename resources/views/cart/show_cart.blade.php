    ...
    <div class="container">
        ...
        <div class="table-responsive cart_info">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="cart_product">
                                <img src="{{config('app.base_url').$cart['product_image']}}" alt="" width="150"
                                    height="150">
                            </td>
                            ...
                            <td class="cart_quantity">
                                <div class="cart_quantity_button">
                                    <button type="button" class="btn btn-default reduction"
                                        data-id="{{$cart['product_id']}}" data-session_id="{{$cart['session_id']}}"> -
                                    </button>
                            ...
                            <td class="cart_total">
                                <p class="cart_total_price" id="sub_total_{{$cart['product_id']}}">
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-default check_out" href="{{url('/delete-all')}}">Xóa toàn bộ sản phẩm
                                </a></td>
            ...
            <tr>
                <td>
                    ...
                    <form action="{{url('/check-coupon')}}" method="POST">
                        ...
                        <input type="text" class="form-control" placeholder="Nhập mã giảm giá" name="coupon"
                            style="margin-left: 18px" required>
                ...
                <td></td>
                <td>
                    <li style="margin-top: -15px">Tổng tiền món ăn: <span
                            id="total">{{number_format($total,0,',','.')}}đ</span></li>
