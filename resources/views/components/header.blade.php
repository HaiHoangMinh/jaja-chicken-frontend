                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="https://www.facebook.com/JaJaChickenVietnam" target="_blank"><i
                                        class="fa fa-phone"></i> +84 0383766181</a></li>
                            <li><a href="https://www.facebook.com/JaJaChickenVietnam" target="_blank"><i
                                        class="fa fa-envelope"></i> hoangloi.sumida@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="social-icons pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="https://www.instagram.com/jaja_friedchicken/" target="_blank"><i
                                        class="fa fa-instagram" target="_blank"></i></a></li>
                            <li><a href="https://mail.google.com/mail/u/0/#sent" target="_blank"><i
                                        class="fa fa-google-plus" target="_blank"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 clearfix">
                    <div class="logo pull-left">
                        <a href="{{route('home')}}">
                            <img src="/images/logo-removebg-preview.png" alt="" height=100px width=100px />
                        </a>
                    </div>
